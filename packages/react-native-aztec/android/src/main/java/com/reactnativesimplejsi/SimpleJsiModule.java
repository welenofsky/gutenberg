...
public class SimpleJsiModule extends ReactContextBaseJavaModule {
  ...
  private native void nativeSendEvent(long jsiPtr, int viewId, String eventName, String content, int selectionStart, int selectionEnd);
  ...
  public void sendEvent(int viewId, String eventName, String text, int selectionStart, int selectionEnd) {
      nativeSendEvent(getReactApplicationContext().getJavaScriptContextHolder().get(), viewId, eventName, text, selectionStart, selectionEnd);
  }
}
